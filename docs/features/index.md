...
| **Full-width board** | On a big screen the board uses the whole window (capped at 1920px and centred), with grid columns that multiply, plus a slide-out tab that opens it from any page of the site, the host application included. [Using the board](../board/usage.md#desktop-the-full-width-board) |
