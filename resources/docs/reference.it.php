...
return [
    ...
    'text' => [
        ...
        'Legacy dashboard path: it redirects to the board (which is full width on every route) and feeds the slide-out board tab. Set to null/false to disable both. Without a home route it serves the board itself.' => 'Vecchio percorso della dashboard: reindirizza alla board (che è a tutta larghezza su ogni rotta) e alimenta la linguetta laterale. Metti null/false per disattivare entrambe. Senza la rotta home serve la board lui stesso.',
